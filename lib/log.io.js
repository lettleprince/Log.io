...
require.define("/src/templates.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  // hxt 此处定义了templates.coffee。
  // hxt 将log_control_streams隐藏，但是同时保留logMessage中的stream属性
  ...
  exports.logControlPanel = "<a class=\"select_mode active\" href=\"#log_control_nodes\">Nodes</a>";
  ...
  LogControlPanel = (function(_super) {
    ...
    LogControlPanel.prototype.initialize = function(opts) {
      ...
      this.streams = new ObjectControls({
        ...
        //hxt 将log_control_streams设置为不可见
        attributes: {
          style: 'display: none'
        }
      });
